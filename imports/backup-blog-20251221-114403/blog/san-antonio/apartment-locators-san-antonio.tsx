...
const ApartmentLocatorsSanAntonio = () => {
  ...
  return (
      title="Apartment Locators San Antonio (2025) | Luxury, Affordable & Second-Chance Friendly"
      publishDate="2025-07-06T12:00:00"
      keywords={[
        "apartment locators San Antonio",
        "free apartment finding San Antonio",
        "San Antonio apartment experts",
      ]}
      content={
        <>
          <p>
