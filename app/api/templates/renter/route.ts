...
<!-- VIDEO SECTION --> <h3 style="margin-top:40px;margin-bottom:16px;font-size:20px;"> Watch My Apartment Process </h3> <div style="font-size:17px;line-height:1.7;color:#444;"> <a href="https://www.youtube.com/embed/GjXNYiV8tHw?si=8P9Q" target="_blank" style=" color:#0b3a75; font-weight:600; text-decoration:none; display:inline-flex; align-items:center; gap:8px; "> <img src="https://res.cloudinary.com/dxtiguwzm/image/upload/v1771299227/youtube-icon_qdqutz.png" alt="YouTube" width="20" height="20" style="display:inline-block;vertical-align:middle;" /> Watch How My Apartment Process Works </a> </div>
