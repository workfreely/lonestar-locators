...
const SanAntonioCityPage = () => {
  const title =
    "Apartments in San Antonio, TX | San Antonio Apartment Locator Guide";
  ...
  const content = (
    <>
      ...
      <ul>
        <li>
          <a href="/san-antonio/free-apartment-locator">
            Free Apartment Locator in San Antonio
          </a>
        </li>
        <li>
          <a href="/san-antonio/luxury-apartments">
            Luxury Apartments in San Antonio
          </a>
        </li>
        <li>
          <a href="/san-antonio/neighborhoods">
            San Antonio Neighborhood Guides
          </a>
        </li>
        <li>
          <a href="/san-antonio/first-time-renters">
            First Time Renters in San Antonio
          </a>
        </li>
        <li>
          <a href="/san-antonio/new-construction-homes">
            New Construction Homes in San Antonio
          </a>
        </li>
        <li>
          <a href="/san-antonio/second-chance-apartments">
