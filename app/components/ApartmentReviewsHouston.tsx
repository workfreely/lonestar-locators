...
export default function ApartmentReviewsHouston() {
  /* ================================
     CITY-SPECIFIC DATA
     ================================ */
  ...
  const allSubmarkets = ["Sugar Land", "Katy"];
...
const matchQuery = matchReviewQuery(q, listing.property_name);
    ...
    const normalize = (str: string) =>
      str.toLowerCase().replace(" houston", "").replace(" tx", "").trim();
