...
// 🚧 TEMP DISABLED – Comparison test page
// This file is intentionally commented out so it does not participate
// in the Next.js build. The code is preserved for use right before launch
// when comparison blogs go live.
//
// To re-enable:
// 1. Uncomment the import
// 2. Uncomment the export default function
// 3. Uncomment the JSX return block
//
